            ...
            <div className="container mx-auto flex justify-between items-center px-4 max-w-7xl z-10">
                <div className="text-container text-center md:text-left w-full md:w-1/2 mb-30 md:mb-32 relative z-10">
                    ...
                    <div className="mt-8">
                        ...
                        <button onClick={handleWorkWithMeClick} className="text-white text-sm md:text-lg py-2 space px-3 md:px-4 border font-bold border-white hover:bg-white hover:text-blue-900 rounded-full transition duration-300">
                            <FontAwesomeIcon icon={faBriefcase} className="mr-0 md:mr-2" /> Work with me
                        </button>
                        <a href="/path-to-your-cv.pdf" target="_blank" rel="noopener noreferrer" className="ml-3 md:ml-4 text-slate-900 text-sm md:text-lg space py-2 px-3 md:px-4 border font-bold bg-white border-white hover:bg-transparent hover:text-white hover:border-white rounded-full transition duration-300">
