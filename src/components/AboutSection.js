...
const AboutMe = () => {
  return (
    <section id="about" className="bg-white pt-10 md:pt-10">
      <div className="container mx-auto md:flex items-center px-4 md:px-12 md:ml-56">
        <div className="w-full md:w-4/6 bg-slate-100 p-6 rounded-xl mb-8 md:mb-0">
          <h2 className="text-xl md:text-3xl font-bold text-left mb-4">About Me</h2>
          <p className="text-gray-700 text-sm md:text-base mb-0 md:mb-4 text-left md:pr-16">
